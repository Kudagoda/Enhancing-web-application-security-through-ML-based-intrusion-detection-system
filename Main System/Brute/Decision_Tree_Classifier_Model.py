...
final_dataset.replace(to_replace=[ 'SSH-Bruteforce', 'FTP-BruteForce', 'Brute Force -Web', 'Brute Force -XSS', 'SQL Injection'], value=0, inplace=True)
...
joblib.dump(DT_clf, 'Attack_Detection_Model')

# Display some sample data before training DecisionTreeClassifier
print("Sample data before training DecisionTreeClassifier:")
print(X_train.head())

# Display some sample data after training DecisionTreeClassifier
print("Sample data after training DecisionTreeClassifier:")
print(X_train.head())
...
print("Decision Tree Classifier Model training completed.")
...
plt.subplot(1, 2, 2)
sns.heatmap(dt_cnf_matrix, annot=True, fmt='d', cmap="Blues", cbar=False)
