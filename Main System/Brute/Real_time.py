...
def predict():
    try:
        traffic = pd.read_csv("FTP-BruteForce.csv")  # Read CSV directly from the file
        ...
        model = joblib.load('models/Random_Forest_Classifier')  # Load RandomForestClassifier model
