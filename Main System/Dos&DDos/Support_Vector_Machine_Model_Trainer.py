...
df1 = pd.read_csv('02-15-2018.csv').sample(n=10000, random_state=42)
df2 = pd.read_csv('02-20-2018.csv').sample(n=10000, random_state=42)
...
final_dataset['Label'] = final_dataset['Label'].map({'Benign': 1, 'Infilteration': 0, 'Bot': 0,
                                                     ...
                                                     'DDoS attacks-LOIC-HTTP': 0, 'DDOS attack-HOIC': 0,
